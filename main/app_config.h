...
constexpr int LCD_DRAW_ROWS =
    120; // partial rows per flush — 3 flushes/frame, ~86KB per PSRAM buffer
...
constexpr Station STATIONS[] = {
    {"NRK P1 Oslo",
     "http://cdn0-47115-liveicecast0.dna.contentdelivery.net/p1_mp3_h",
     "nrk_p1.png", 0x1A1A2E},
    {"NRK P2",
     "http://cdn0-47115-liveicecast0.dna.contentdelivery.net/p2_aac_h",
     "nrk_p2.png", 0x16213E},
    {"NRK P3",
     "http://cdn0-47115-liveicecast0.dna.contentdelivery.net/p3_mp3_h",
     "nrk_p3.png", 0x0F3460},
    {"NRK MP3",
     "http://cdn0-47115-liveicecast0.dna.contentdelivery.net/mp3_mp3_h",
    ...
    {"Radio Rock", "http://live-bauerno.sharp-stream.com/radiorock_no_mp3",
     "radio_rock.png", 0x5C1010},
    {"Radio Norge", "http://live-bauerno.sharp-stream.com/radionorge_no_mp3",
     "radio_norge.png", 0x1A3A5C},
    {"NRJ Norge", "http://live-bauerno.sharp-stream.com/kiss_no_mp3",
     "nrj.png", 0x5C1A3A},
};
